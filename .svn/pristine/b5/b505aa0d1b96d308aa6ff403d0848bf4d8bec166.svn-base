...
<body>
		...
		<form:form id="form" name="form" action="editContract" method="post" modelAttribute="contract">
	...
	<tr>
        ...
        <td  class="kv-label"><form:input path="prName"  readonly="true"/></td>
		<form:errors path="prId"></form:errors>
	</tr>
	<tr>
        <td class="tb-left">栋号：</td> 
        <td  class="kv-label"><form:input path="pcpNumber" readonly="true"/></td>
		<form:errors path="pcpNumber"></form:errors>
	</tr>
	<tr>
        <td class="tb-left">分部：</td>
        <td  class="kv-label"><form:input path="pName" readonly="true"/></td>
		<form:errors path="pId"></form:errors>
	</tr>		
	<tr>
        <td class="tb-left">工程部位/分项1：</td>
        <td  class="kv-label"><form:input path="psName" readonly="true"/></td>
		<form:errors path="psId"></form:errors>
	</tr>		
	<tr>
        <td class="tb-left">工作项目 /分项2：</td>
        <td  class="kv-label"><form:input path="jobName" readonly="true"/></td>
		<form:errors path="jobName"></form:errors>
	</tr>		
		
	<tr>
        <td class="tb-left">单位：</td>
        <td  class="kv-label"><form:input path="unName" readonly="true"/></td>
		<form:errors path="unId"></form:errors>
	</tr>		
	
	<tr>
        <td class="tb-left">单价：</td>
        <td  class="kv-label"><form:input id="price" name="price" path="price"/></td>

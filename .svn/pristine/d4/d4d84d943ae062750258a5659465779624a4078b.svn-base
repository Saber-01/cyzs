...
<body>
      ...
      <table id="showProject" class="kv-table">
            ...
            <tr>
                <td class="kv-label" style="width:37%;text-align:left;padding-left:15%">工程名称：</td>
                <td class="kv-label">
           ...
           <tr>     
                 <td class="kv-label" style="width:37%;text-align:left;padding-left:15%">栋号：</td>
          ...
          <tr>
                <td class="kv-label" style="width:37%;text-align:left;padding-left:15%">工程部位：</td>
                <td class="kv-label">
                   <select name="psId" id="psId" style="width:153px;height:30px">
                      <option value="">----请选择----</option>
                     <c:forEach items="${psList}" var="r">
                        <option value="${r.psId}">${r.psName}</option>
                      </c:forEach>
                    </select>
                </td>
                <td class="kv-label"></td>
           ...
           <tr> 
                <td class="kv-label" style="width:37%;text-align:left;padding-left:15%">工作项目/分项2：</td>
                <td  class="kv-label">
          ...
          <tr>      
                <td class="kv-label" style="width:37%;text-align:left;padding-left:15%">结算单位：</td>
                <td  class="kv-label">
          ...
          <tr>      
                <td class="kv-label" style="width:37%;text-align:left;padding-left:15%">单位：</td>
                <td class="kv-label">
          ...
          <tr>
              <td class="kv-label" style="width:37%;text-align:left;padding-left:15%">单价：</td>
              <td class="kv-label"><input type="text" id ="price" name="price" style="height:25px"/></td>
              <td class="kv-label"></td>
          </tr>                   
</table>

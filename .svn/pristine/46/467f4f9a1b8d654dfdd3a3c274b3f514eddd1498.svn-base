	...
	<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
		<tbody>
			<tr>
				...
				<font style="font-size:1.2em;">合同外补差价任务书</font>
				</td>
			</tr>
	</tbody>
	</table>
	<c:if test="${error == null }">
	<form name="addmissionform" method="post" action="addHTWBCJMission" onSubmit="">
		...
		<table id="addmission" class="table table-striped table-bordered table-condensed">
			...
			<td>&nbsp;&nbsp;
		   	  工作月度：<select style="width:100px;height:30px;line-height:35px;" id="styear" name="styear">
						...
						<select style="width:100px;height:30px;line-height:35px;" name="stmonth">
				...
				<td colspan=2>&nbsp;&nbsp;
				<a onclick="window.open('preUploadFile?mid=${user.userLoginName }',

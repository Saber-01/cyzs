...
public class InProjectVo implements Serializable {
    ...
    private InPrIndexPc inPrIndexPc;

	public InPrIndexPc getInPrIndexPc() {
		return inPrIndexPc;
	}

	public void setInPrIndexPc(InPrIndexPc inPrIndexPc) {
		this.inPrIndexPc = inPrIndexPc;
	}
    ...
    public void setJingliId(String jingliId) {
        this.jingliId = jingliId == null ? null : jingliId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", prTime=").append(prTime);
        sb.append(", shenjiId=").append(shenjiId);
        sb.append(", jingliId=").append(jingliId);

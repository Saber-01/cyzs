...
<script type="text/javascript">
	...
	function addNewContractRow(otable) {
		...
		col.innerHTML = '<TD><div align="center"><input type="text" size="5" name="contentSerial"  size="8" value='
		...
		//col = row.insertCell();
		//col.innerHTML = '<TD><div align="center"><input type="text" size="8" name="partItemthreeText" id="partItemthreeText'+FlowListTable.rows.length+'" readonly><input type="hidden" value="" name="fsId"></div></TD>';
		col = row.insertCell();
		...
		col = row.insertCell();
		col.innerHTML = '<TD><div align="center"><input type="text" size="10" name="wageSum" readonly></div></TD>';
		col = row.insertCell();
	...
	<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
		<tbody>
			<tr>
				...
				<font style="font-size:1.2em;">计时任务书</font>
				</td>
			</tr>
		</tbody>
	</table>
	<c:if test="${error == null }">
<form name="addmissionform" method="post" action="addJSMission" onSubmit="">
	...
	<table id="addmission" class="table table-striped table-bordered table-condensed">
		...
		<tr>
			<td>&nbsp;&nbsp;
		  	工作日期 : <input type="text" size="10" name="beginDate" value="${date }" 
		  				id="dd" class="easyui-textbox" style="width:135px;height:30px;line-height:35px; required"> 
		...
		<table id="customers">
			<tr>
				...
				<th style="width: 10%">当日实际用工数量</th>
				<th style="width: 9%">工资金额</th>

...
<body>
	...
	<form id="form" name="form" action="/editPosition" method="post">
	<input type="hidden" id="psId" name="psId" value="${partPosition.psId}"/>
	      	<table class="kv-table" id="addPart">
		<tr>
                <td class="tb-left">工程部位：</td>
                <td  class="kv-label">
                   <input type="text" name="psName" id="psName" value="${partPosition.psName}" style="height:25px">                  
                </td>
         </tr>
		<tr>
                ...
                <td  class="kv-label">
                   <select name="pId" id="pId" style="width:153px;height:30px">
                      <option value="${partPosition.pId}">${partPosition.pName}</option>   
        ...
        <td class="kv-label"><textarea name="txt" clos="15" rows="3" id ='remark' name='remark'  value="${partPosition.remark}" style="width:153px;height:60px"></textarea>

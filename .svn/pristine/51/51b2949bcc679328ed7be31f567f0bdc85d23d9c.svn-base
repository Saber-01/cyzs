...
<body>
    <div class="container">
       <div id="tb" style="padding:30 30px;">
       	<form name="stopauditForm" method="post" action="stopCreateMission" onSubmit="">
      <table class="kv-table" title="暂时关停新建任务书功能" style="width:100%;height:220px;border:0px">
			<tr>
				<td class="kv-label" colspan="3" bgColor=#efefef style="padding-left:530px">暂时关停新建任务书功能</td>
			</tr>
			<tr>

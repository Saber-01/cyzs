...
<div id="tbView">
	<table id="customers" style="margin-top:20px;">
		...
		<c:choose>
		  <c:when test="${contracts==null && fn:length(contracts)==0}">
		        <tr>
					<td colspan=9>没有操作！</td>
				</tr>
		  </c:when>
		  <c:when test="${not empty message}">
		        <tr>
					<td  colspan = "9"><h3 style="color:red">${message}</h3></td>
			   </tr>
		  </c:when>
		  <c:otherwise>
		...
		<tr>
		<td colspan = "9"><h3 style="color:red">成功导入${saveCount}条记录，覆盖了${existCount}条记录。</h3></td>
	    </tr>	
	</table>
</form>	
</div>

...
<body>
		...
		<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
			<tbody>
				<tr>
					...
					<font style="FONT-SIZE: 14px; LETTER-SPACING: 2px; color:#151e14">已删除合同外补差价任务书详细信息</font>
					</c:when>
					<c:otherwise>
					<font style="FONT-SIZE: 14px; LETTER-SPACING: 2px; color:#171e24">合同外补差价任务书详细信息</font>
					</c:otherwise>
					</c:choose>
					</td>
				</tr>
	...
	<div id="tbView">
			<table id="viewMission">
				...
				<tr>
					<td colspan="10">
						<div align="center">合同外补差价任 务 书 详 细 信 息</div>
						<div align="right">

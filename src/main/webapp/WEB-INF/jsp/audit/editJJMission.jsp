	...
	<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
		<tbody>
			<tr>
				...
				<font style="font-size:1.2em;">修改计件任务书</font>
				</td>
			</tr>
		</tbody>
	</table>
		<form name="editmissionform" method="post" action="editMission">
			...
			<table id="viewMission">
				...
				<tr>
					<td colspan="13">
						<div align="center">计 件 任 务 书 详 细 信 息</div>
						<div align="right">
      ...
      <c:forEach items="${missionContentList}" var="mcl">
        <tr>
            ...
            <input type="text" size="5" name="unName" readonly value="${mcl.unName }"/>
             ...
             <td>
            <input type="text" size="5" name="price" readonly value="${mcl.price }"/>
            </td> 
             <td>
            ...
            <td>
            <input type="text" size="5" name="accQuantity" readonly value="${mcl.accumulateSum }"/>
            </td> 
             <td>

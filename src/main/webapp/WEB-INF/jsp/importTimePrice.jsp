...
<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
		<tbody>
			<tr>
				...
				<font style="font-size:1.2em;">计时单价导入</font>
				</td>
			</tr>
		</tbody>
</table>
...
<br>
    <form action="timePrice/uploadFile" name="fileuploadform" method="POST" enctype="multipart/form-data">
		<!-- <input type="file" name="uploadfile" id="uploadfile" maxlength="200" class="easyui-filebox">
		<input type="button" value="开始上传" onclick="if(validate())fileuploadform.submit();" class="easyui-linkbutton"> -->
		...
		&nbsp;&nbsp;<a href="<%=basePath%>/timePrice/downloadFile">范本下载</a>
	</form> 
	 
<form action="timePrice/importTimePriceExcel" name="importTimePriceForm">
<input type="hidden" name="filename" id="filename" value="${filename}">
</form>	
	   <input type="button" value="导入数据库" class="easyui-linkbutton" onclick="if(validate1())importTimePriceForm.submit()"/>
		<br /><br />
 ...
 {  
    ...
    if(filename != ""){  
        $.ajax({  
               ...
               url:"timePrice/importTimePriceExcel",  
               data:filename,  
               dataType:"String",
               async: false,  

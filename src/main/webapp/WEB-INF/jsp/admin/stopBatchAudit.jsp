...
<body>
    <div class="container">
       ...
       <form name="stopauditForm" method="post" action="stopBatchAudit" onSubmit="">
       <table class="kv-table" title="暂时关停审核功能" style="width:100%;height:220px;border:0px">
			<tr>
				<td class="kv-label" colspan="3" bgColor=#efefef style="padding-left:530px">暂时关停批量审核功能</td>
			</tr>
			<tr>

  ...
  <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
		<tbody>
			<tr>
				...
				<font style="font-size:1.0em;">项目劳务工资支付明细表查询</font>
				</td>
			</tr>
		</tbody>
	</table>
		...
		%>		
    <form action="statistic/getLWGZZF" onsubmit="return doTest()">
    	<input type="hidden" id="roleName" name="roleName" value="${roleName}"/>
    	<table id="lwfbList" border="1" class="table table-striped table-bordered table-condensed" width="100%">
    		<tr>
